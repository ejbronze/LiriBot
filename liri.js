  ...
  concertThis: function(cmd, data) {
    ...
    axios
      ...
      .then(function(response) {
        ...
        //write the header
        app.doHeader(
          events.length + " results found for: " + data + " (" + cmd + ")"
        );
  ...
  spotifyThisSong: function(cmd, data) {
    ...
    spotify
      ...
      .then(function(response) {
        ...
        //write the header
        app.doHeader(
          tracks.length + " results found for: " + data + " (" + cmd + ")"
        );
...
//Some of this code was done with help from Michael-Instructor.
// Other parts of this code were taken from online tutorials via Youtube for making API call-backs
//The bonus was with help from a tutor.
